...
//     // WHEN
//     const returnMessage: string = await cartService.deleteCartItem({ customerId, productName });
...
//     // WHEN
//     const deleteCartItem = () => cartService.deleteCartItem({ customerId, productName });
